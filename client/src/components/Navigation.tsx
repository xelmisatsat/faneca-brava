      ...
      >
        <div className="nav-pill flex items-center gap-1 px-4 py-2.5">
          ...
          <button
            ...
            className="font-display text-sm font-light tracking-[0.2em] px-3 py-1 mr-2 rounded-full transition-all duration-300"
            style={{ color: '#C8A96E', cursor: 'none', letterSpacing: '0.25em' }}
          >
            FB
          </button>
