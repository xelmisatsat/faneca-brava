...
export default function NavPill({ sections, activeIdx, onSelect }: NavPillProps) {
  ...
  return (
    <>
      <div id="nav-pill-wrapper" className="fixed z-[1000] transition-opacity duration-300" style={{ top: m ? 'auto' : '20px', bottom: m ? '24px' : 'auto', left: '50%', transform: 'translateX(-50%)', width: 'max-content', maxWidth: 'calc(100vw - 2rem)' }}>
        <motion.div
          drag={m ? "x" : false}
          ...
          style={{
            ...
            gap: '6px',
            padding: '8px 16px',
            background: m ? 'linear-gradient(180deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0.05) 100%)' : 'linear-gradient(135deg, rgba(255,255,255,0.13) 0%, rgba(255,255,255,0.06) 50%, rgba(255,255,255,0.10) 100%)',
            backdropFilter: m ? 'blur(50px) saturate(220%) brightness(1.2)' : 'blur(60px) saturate(200%) brightness(1.1)',
            WebkitBackdropFilter: m ? 'blur(50px) saturate(220%) brightness(1.2)' : 'blur(60px) saturate(200%) brightness(1.1)',
            border: m ? '1px solid rgba(255,255,255,0.15)' : '1px solid rgba(255,255,255,0.18)',
            borderTop: m ? '1px solid rgba(255,255,255,0.4)' : '1px solid rgba(255,255,255,0.30)',
            borderRadius: '9999px',
            boxShadow: m ? 'inset 0 1px 2px rgba(255,255,255,0.4), inset 0 -1px 2px rgba(255,255,255,0.1), 0 16px 40px rgba(0,0,0,0.6)' : '0 4px 24px rgba(0,0,0,0.5), 0 1px 4px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.20)',
            position: 'relative',
            overflow: 'visible',
            cursor: m ? 'grab' : 'default',
          }}
          initial={{ y: m ? 80 : -80, opacity: 0 }}
        ...
        >
          ...
          >
            <svg width="14" height="16" viewBox="0 0 384 512" fill="currentColor" style={{ flexShrink: 0 }}>
              <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/>
            </svg>
            <span style={{ paddingTop: '2px' }}>FB</span>
          </button>
