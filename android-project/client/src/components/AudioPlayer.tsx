...
// Música por sección — galega tradicional nas máis importantes (Offline APK)
const SECTION_MUSIC: Record<string, string> = {
  hero:       "/audios/music-hero_8cb331ab.mp3",
  sobre:      "/audios/music-galega-trad_8407bfe4.mp3",
  historia:   "/audios/music-galega-trad_8407bfe4.mp3",
  personaxes: "/audios/music-personaxes_cc141ca2.mp3",
  galeria:    "/audios/music-galeria_9feedf8a.mp3",
  timeline:   "/audios/music-historia_428d5e7d.mp3",
  arquivo:    "/audios/music-personaxes_cc141ca2.mp3",
  libro:      "/audios/music-galega-trad_8407bfe4.mp3",
  autor:      "/audios/music-historia_428d5e7d.mp3",
  conversa:   "/audios/music-hero_8cb331ab.mp3",
  mercar:     "/audios/music-galeria_9feedf8a.mp3",
};
