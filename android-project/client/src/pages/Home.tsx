...
const NfcShareOverlay    = lazy(() => import("@/components/NfcShareOverlay"));
    ...
    <>
      ...
      {showContent && (
        <>
          ...
          {/* Overlay NFC Share — actívase cando dous dispositivos se tocan */}
          <Suspense fallback={null}><NfcShareOverlay /></Suspense>
